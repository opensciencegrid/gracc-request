...
class OIMVOInfo(object):
    ...
    oim_url = "https://topology.openhtc.org/vosummary/xml?summary_attrs_showfield_of_science=on&all_vos=on&active=on&active_value=1&oasis_value=1&sort_key=name"
